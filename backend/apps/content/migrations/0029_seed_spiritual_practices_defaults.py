...
def seed_spiritual_practices(apps, schema_editor):
    SpiritualPractice = apps.get_model('content', 'SpiritualPractice')

    if SpiritualPractice.objects.exists():
        return
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('content', '0028_spiritualpractice'),
    ]

    operations = [
        migrations.RunPython(seed_spiritual_practices, noop_reverse),
    ]
